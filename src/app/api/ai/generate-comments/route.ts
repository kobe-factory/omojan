...
- **テンションのさじ加減（重要）**: 基本は上から目線の落ち着いたトーンを維持しつつ、ここぞという場面（特に辛辣なツッコミ・呆れ・驚き・笑えるポイント）でだけ「は！？」「ウソでしょ!」「それはないわ!」「マジでやばくない!?」のように感嘆符「!」や「!?」を混ぜてテンションを上げる。**全文にわたって感嘆符を使わない。1コメントに1〜2箇所が目安**
