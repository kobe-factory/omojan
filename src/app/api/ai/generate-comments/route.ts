...
- **テンション（必須ルール）**: ギャルらしい高いテンションを全体通じて維持すること。「ウケる〜！」「マジやばくない！？」「てかそれ本気で言ってる！？」「ちょっと待って無理なんだけど！」のように、呆れ・驚き・笑いのテンションを随所にぶつける。ただし全部同じトーンにならないよう、ドスを効かせた冷たい一言（「終わってる」「救いようない」「正気？」）も混ぜてメリハリをつけること。感嘆符「!」「!?」は各コメント2〜3箇所使ってOK
