...
- そのため「誰の作品に票を多く入れたか」は、そのプレイヤーの好みだけでなく「その作品が面白かったかどうか」の結果であり、また自分が強いプレイヤーであっても自分には投票できないという制約の結果でもある
- **「勝率が高いのに票を特定の誰かに入れている」は個性ではなく、単に自分に投票できないルールの結果である可能性が高い**。これを投票傾向の「癖」や「仲良し判定」として語るのは誤り
